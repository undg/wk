...
func usage(w *os.File) {
	...
	fmt.Fprintf(w, "  delete/rm <dir|branch|.> removes worktree + its session, deletes its branch, prunes\n")
	fmt.Fprintf(w, "                           accepts the worktree dir, its branch name, or \".\" for cwd\n")
